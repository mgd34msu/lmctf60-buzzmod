...
{
	//armor
	[("Armor Shard", 0), ("shard", 0)]
	[("Jacket Armor", 0), ("green armor", 0), ("jacket", 0)]
	[("Combat Armor", 0), ("yellow armor", 0), ("ya", 0)]
	[("Body Armor", 0), ("red armor", 0), ("ra", 0)]
	//health
	[("Mega Health", 0), ("mh", 0)]
	//weapons
	[("Shotgun", 1), ("sg", 0.5), ("shot gun", 0)]
	[("Super Shotgun", 1), ("ssg", 0.5), ("double barrel", 0)]
	[("Machinegun", 1), ("mg", 0), ("machine gun", 0)]
	[("Chaingun", 1), ("cg", 0), ("chain gun", 0)]
	[("Grenade Launcher", 1), ("gl", 0.1), ("GL", 0.7)]
	[("Rocket Launcher", 1), ("rl", 0.1), ("RL", 0.7)]
	[("HyperBlaster", 1), ("hyperblaster", 1), ("hb", 0)]
