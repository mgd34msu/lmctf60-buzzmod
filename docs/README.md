...
History (kept for the record; superseded by the above):
- HANDOFF-2026-09-01.md, ERA4-REWRITE-INVENTORY.md, ERA4-HOST-INVENTORY.md,
  ERA4-CELL-BUILDER.md, era4-deleted-units.txt -- the rewrite's plans and
  inventories.  The generator module split they describe is gone: the
  shipped module builds runes itself.
- RUNE-BUILD-CHECKLIST.md, sg-rune-compact-field-cache-design.md,
  sg-rune-v13-pmove-control-design.md, hook-visibility-relation.md --
  earlier designs and checklists.
