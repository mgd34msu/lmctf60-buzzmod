...
static const sg_weapon_profile_t weapon_profiles[] = {
	...
	},
	{
		...
		.projectile_speed = SG_HOST_ROCKET_SPEED,
		.projectile_speed_max = SG_HOST_ROCKET_SPEED,
		.projectile_retire_distance = SG_HOST_PROJECTILE_RETIRE_DISTANCE,
		.splash_radius = SG_HOST_ROCKET_SPLASH_RADIUS,
		.splash_radius_max = SG_HOST_ROCKET_SPLASH_RADIUS,
		.direct_damage = SG_HOST_ROCKET_DAMAGE_BASE,
		.direct_damage_max = SG_HOST_ROCKET_DAMAGE_BASE +
			SG_HOST_ROCKET_DAMAGE_RANDOM_SPAN,
		.splash_damage = SG_HOST_ROCKET_SPLASH_DAMAGE,
		.splash_damage_max = SG_HOST_ROCKET_SPLASH_DAMAGE,
		.self_damage_scale = SG_HOST_RADIUS_SELF_SCALE,
		.teammate_risk_scale = 1.0f,
		.cadence_ms = 900U,
		ORDINARY_SPLASH,
