...
/* These calls do not change any RUNE action gate. CompoundPreopen reserves
 * execution only after runtime admission. Both laws share one process-wide
 * transaction: either acquire conflicts while any lease or
