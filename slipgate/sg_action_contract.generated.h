/* Generated contract. DO NOT EDIT. */
...
#define SG_RUNE_PROOF_AIR_HOOK_CONTROL_MARKER 252
#define SG_RUNE_PROOF_AIR_HOOK_RUNUP_FRAMES 8
...
static inline int SG_ActionMechanismPlanRequired(int action)
{
	switch (action)
	{
	case RL_LIFT: case RL_TELEPORT: case RL_DOOR: case RL_BUTTON_DOOR: case RL_PUSH: case RL_TRAIN: return 1;
	default: return 0;
	}
}
