...
#define SG_RUNE_ACTION_CONTRACT_CRC32 0xe1731b32U
#define SG_RUNE_ACTION_CONTRACT_SHA256 "e796be082c42748203c1dddc64f3eea1b2d64fc4be2dc2be7b65962c5ddd9c0f"
#define SG_RUNE_ACTION_CONTRACT_DESCRIPTOR "rune-action-contract;actions=run:0,jump:1,drop:2,hook:3,swim:4,lift:5,teleport:6,rocketjump:7,door:8,door_drop:9,door_swim:10,door_hook:11;additional=button_door:12;button_door.link_policy=button_door:12;button_door.anchor=first_touch_support,endpoint_q8_displacement;runtime=run:0,jump:1,drop:2,hook:3,swim:4,lift:5,teleport:6,door:8,button_door:12;disabled=rocketjump:7,door_drop:9,door_swim:10,door_hook:11;planless=run:0,jump:1,drop:2,hook:3,swim:4;plan_required=lift:5/platform:5,teleport:6/teleport:6,door:8/auto_door:1|direct_trigger_door:2,button_door:12/button_door:3;seed.origin=signed_q8_exact;"
...
#define SG_ACTION_MECHANISM_REQUIREMENT_ROWS(X) \
	...
	X(RL_ROCKETJUMP, 0, 0, RL_ROCKETJUMP) \
	X(RL_DOOR, 1, 1, RL_DOOR) \
	X(RL_DOOR_DROP, 0, 0, RL_DOOR_DROP) \
	X(RL_DOOR_SWIM, 0, 0, RL_DOOR_SWIM) \
...
static inline int SG_ActionMechanismAdmitted(int action)
{
	switch (action)
	{
	case RL_RUN: case RL_JUMP: case RL_DROP: case RL_HOOK: case RL_SWIM: case RL_LIFT: case RL_TELEPORT: case RL_DOOR: case RL_BUTTON_DOOR: return 1;
	default: return 0;
	}
}
...
#define SG_ACTION_CONTRACT_ROWS(X) \
	...
	X(RL_ROCKETJUMP, 7, 0, RL_PROVEN, 0x000fU, 0x01U, 0x0003U, RLEP_DRY_BOTH, RLAP_UNSUPPORTED, RLAP_ZERO, RLAP_ZERO, RLCP_UNSUPPORTED, RLMP_NONE, RL_ROCKETJUMP, RLFB_FIXED, 900, "ROCKETJUMP", "RJ", "#ff3b30") \
	...
	X(RL_DOOR_SWIM, 10, 0, RL_CONTRACTED, 0x0010U, 0x02U, 0x007dU, RLEP_FROM_WATER, RLAP_ZERO, RLAP_DOOR_PREOPEN_CONTACT, RLAP_ZERO, RLCP_SWIM, RLMP_DOOR_WORLD_FIXED_1_8, RL_SWIM, RLFB_INHERIT, 0, "DOOR_SWIM", "D_SWIM", "#5a9cff") \
