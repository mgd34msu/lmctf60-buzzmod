...
#define SG_RUNE_ACTION_CONTRACT_CRC32 0x3dcf09c1U
#define SG_RUNE_ACTION_CONTRACT_SHA256 "e65b336403c1c4035c9775d7993025b452160ac365ce275735671bc9e1bbbc79"
#define SG_RUNE_ACTION_CONTRACT_DESCRIPTOR "rune-action-contract;actions=run:0,jump:1,drop:2,hook:3,swim:4,lift:5,teleport:6,rocketjump:7,door:8,door_drop:9,door_swim:10,door_hook:11;additional=button_door:12,push:13,train:14;button_door.link_policy=button_door:12;button_door.anchor=first_touch_support,endpoint_q8_displacement;runtime=run:0,jump:1,drop:2,hook:3,swim:4,lift:5,teleport:6,rocketjump:7,door:8,door_drop:9,door_swim:10,door_hook:11,button_door:12,push:13,train:14;disabled=;planless=run:0,jump:1,drop:2,hook:3,swim:4,rocketjump:7,door_drop:9,door_swim:10,door_hook:11;plan_required=lift:5/platform:5,teleport:6/teleport:6,door:8/auto_door:1|direct_trigger_door:2,button_door:12/button_door:3,push:13/push:7,train:14/train:8;seed.origin=signed_q8_exact;"
#define SG_MECHANISM_CONTRACT_CRC32 0x15be80dbU
#define SG_MECHANISM_CONTRACT_SHA256 "16842a998ca814e63680138b60d367794e7879a16e351cdd8830ee7a317c2218"
...
static inline int SG_ActionMechanismPlanAllowed(int action, uint16_t controller)
{
	...
	case RL_TRAIN: return controller == SG_MECHANISM_CONTROLLER_TRAIN;
	default: return 0;
	}
}
...
#define SG_ACTION_CONTRACT_ROWS(X) \
	...
	X(RL_TRAIN, 14, 1, RL_DECLARED, 0x0008U, 0x01U, 0x003dU, RLEP_DRY_BOTH, RLAP_WORLD, RLAP_ZERO, RLAP_ZERO, RLCP_DECLARED, RLMP_NONE, RL_TRAIN, RLFB_NONE, 0, "TRAIN", "TRAIN", "#00a6a6")
