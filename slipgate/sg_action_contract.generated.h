...
#define SG_RUNE_ACTION_CONTRACT_CRC32 0xf07312cdU
#define SG_RUNE_ACTION_CONTRACT_SHA256 "45720f9a172783e8e2a41f69d7fcb07d88409a6d3f598098c87af3e2c9518188"
#define SG_RUNE_ACTION_CONTRACT_DESCRIPTOR "rune-action-contract;actions=run:0,jump:1,drop:2,hook:3,swim:4,lift:5,teleport:6,rocketjump:7,door:8,door_drop:9,door_swim:10,door_hook:11;additional=button_door:12;button_door.link_policy=button_door:12;button_door.anchor=first_touch_support,endpoint_q8_displacement;runtime=run:0,jump:1,drop:2,hook:3,swim:4,lift:5,teleport:6,rocketjump:7,door:8,door_swim:10,button_door:12;disabled=door_drop:9,door_hook:11;planless=run:0,jump:1,drop:2,hook:3,swim:4,rocketjump:7,door_swim:10;plan_required=lift:5/platform:5,teleport:6/teleport:6,door:8/auto_door:1|direct_trigger_door:2,button_door:12/button_door:3;seed.origin=signed_q8_exact;"
...
#define SG_ACTION_MECHANISM_REQUIREMENT_ROWS(X) \
	...
	X(RL_DOOR_DROP, 0, 0, RL_DOOR_DROP) \
	X(RL_DOOR_SWIM, 1, 0, RL_DOOR_SWIM) \
	X(RL_DOOR_HOOK, 0, 0, RL_DOOR_HOOK) \
...
static inline int SG_ActionMechanismAdmitted(int action)
{
	switch (action)
	{
	case RL_RUN: case RL_JUMP: case RL_DROP: case RL_HOOK: case RL_SWIM: case RL_LIFT: case RL_TELEPORT: case RL_ROCKETJUMP: case RL_DOOR: case RL_DOOR_SWIM: case RL_BUTTON_DOOR: return 1;
	default: return 0;
	}
}
...
#define SG_ACTION_CONTRACT_ROWS(X) \
	...
	X(RL_DOOR_DROP, 9, 0, RL_CONTRACTED, 0x0010U, 0x06U, 0x007dU, RLEP_FROM_DRY, RLAP_DROP_LIP, RLAP_DOOR_PREOPEN_CONTACT, RLAP_DOOR_RIDE_INGRESS_LIP, RLCP_DROP, RLMP_DOOR_WORLD_FIXED_1_8, RL_DROP, RLFB_INHERIT, 0, "DOOR_DROP", "D_DROP", "#d4a600") \
	...
	X(RL_DOOR_HOOK, 11, 0, RL_CONTRACTED, 0x0010U, 0x02U, 0x007dU, RLEP_WATER_TO_DRY, RLAP_HOOK_CONTROL, RLAP_DOOR_PREOPEN_CONTACT, RLAP_ZERO, RLCP_HOOK, RLMP_DOOR_WORLD_FIXED_1_8, RL_HOOK, RLFB_INHERIT, 0, "DOOR_HOOK", "D_HOOK", "#ff5bbd") \
