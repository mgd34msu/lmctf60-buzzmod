 ...
 *  Public header file.
 *
 * $Id: stdlog.c,v 1.1 1998/10/29 18:58:09 yun Exp $
 *
 */
...
//static const char *_unused_id_stdlog_c = "$Id: stdlog.c,v 1.1 1998/10/29 18:58:09 yun Exp $";
//static const char *_unused_id_stdlog_h = __STDLOG_ID__;

//SURT commented out above two lines at request of MJD, see text below.

//MJD These cause warnings because they aren't used.  However, that is
//MJD okay - This is a kinda standard thingy to do.  If the author doesn't
//MJD mind, I would yank these two lines.  We might consider putting a line
//MJD like this into the rest of the library - otherwise it is impossible to
//MJD tell apart library files from the outside:
