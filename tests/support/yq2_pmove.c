...
/*
 * Test-only exact Yamagi Quake II Pmove, vendored from
 * https://github.com/yquake2/yquake2.git at
 * 25a7d3f97a3d43f0ea2bd7f2466c0ec5f305c66b.
 * Upstream source SHA256:
 * bd5c4ec92b8bb038a39cec118da9559aec94108451794109ecdde77df7aa52c1
 *
 * Test adaptations: replace Yamagi's engine/client include trio with this
 * game tree's ABI-identical q_shared.h, and declare the engine-owned
 * Com_DPrintf callback supplied by the harness. The focused target compiles
 * DEDICATED_ONLY, so client-only sound paths remain excluded.
 */
#include "q_shared.h"
