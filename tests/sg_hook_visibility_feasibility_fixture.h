...
typedef struct hook_visibility_fixture_s
{
	...
	sg_bsp_plane_t planes[25];
	sg_bsp_node_t node;
	sg_bsp_leaf_t leaves[2];
	uint32_t leaf_brushes[8];
	sg_bsp_model_t model;
	sg_bsp_brush_t brushes[4];
	sg_bsp_brush_side_t brush_sides[24];
	sg_bsp_texinfo_t texinfos[4];
	sg_host_collision_authority_t authority;
	sg_hook_visibility_control_root_t controls[2];
	sg_hook_visibility_surface_rule_t rules[4];
