...
sources='tests/sg_rune_artifact_test.c slipgate/sg_rune_artifact.c slipgate/sg_rune_law.c slipgate/sg_rune_cx.c slipgate/sg_rune_movement.c slipgate/sg_rune_analytic.c slipgate/sg_rune_crc.c'
cd "$repo_dir"
for cc in gcc clang
do
