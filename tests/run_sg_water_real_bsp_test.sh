...
strict='-DDEDICATED_ONLY -DSG_HOST_LAW_TESTING -std=c11 -Wall -Wextra -Wpedantic -Werror'
...
cc $strict -I. -c slipgate/sg_host_law_publication.c \
	-o "$tmp_dir/host-law-publication.o"
cc $strict -I. -c slipgate/sg_host_hook_law.c -o "$tmp_dir/hook-law.o"
cc $strict -I. -c slipgate/sg_host_mechanism_law.c \
	-o "$tmp_dir/mechanism-law.o"
...
cc "$tmp_dir/test.o" "$tmp_dir/pmove.o" "$tmp_dir/collision.o" \
	...
	"$tmp_dir/host-law-publication.o" "$tmp_dir/hook-law.o" \
	"$tmp_dir/mechanism-law.o" "$tmp_dir/q-shared.o" -Wl,--gc-sections -lm \
	-o "$tmp_dir/water-real-bsp"
