...
typedef struct fixture_observation_s
{
	...
	int suffix_commands;
	int hook_opening_commands;
	int hook_opening_zero_commands;
	int hook_opening_corrective_commands;
	int trace_calls;
	int link_calls;
	float link_origins[16];
	qboolean stage_started;
	qboolean top_staged;
	qboolean hook_opening_started;
	qboolean hook_started;
	pmove_state_t last_hook_opening;
