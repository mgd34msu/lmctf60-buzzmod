...
# carry-hop NULL (271-273): airtime dosed 40->44->52%% but speed INVERTED
# (194->191->182) and caps stayed 0 -- short-clearance hops trade friction
# for wall contact; the airtime gauge is gameable. Ledger.
# carrier cover trial (274+): candidate steps visible to the freshest eye
...
CARRYCOVER=("0" "0" "400" "400" "400" "400" "400" "400" "400" "0")
