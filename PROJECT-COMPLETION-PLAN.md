...
| `tw2ctf4` | Current immutable generation proves 2,066 seeds/31,850 links, then all prune: 596 red-only, 606 blue-only, 0 shared, and 864 neither. Exact condensation puts the roots in separate 555- and 562-seed SCCs, with a third isolated 414-seed neutral SCC. Fair unchanged RUN replay proves zero across both objective cuts. The only unmodeled authentic inventory is six shoot-activated door teams; their full motion sweeps are being mapped to adjacent SCCs before any source change. |
