...
| `lmctf45` | Fresh current source has 1,369 seeds/14,598 links: 687 red-only, 227 blue-only, 157 shared, 298 neither; pruning removes the one-sided sets then the shared core. Roots bind with outgoing links. Exact directed SCC cuts are under existing DROP/HOOK/teleport-family replay. |
